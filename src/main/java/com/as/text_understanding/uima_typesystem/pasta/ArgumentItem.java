 ...
 * @generated */
public class ArgumentItem extends Annotation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ArgumentItem.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ArgumentItem() {/* intentionally empty block */}
   ...
   */
  public ArgumentItem(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public ArgumentItem(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
